    ...
    <div class="col-lg-6 d-non d-lg-block">
        <div class="p-5">
            <div class="text-center">
                <h1 class = "h4 text-gray-900 mb-4">입출금 거래 추가</h1>
            </div>
            <div class="form-group col-md-6">
                <label for="typeselect">계정과목</label>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="inputbriefs">적요</label>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputmoeny">금액</label>
                    <input type="form-control" type="text" id="inputmoney">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputetc">비고</label>
